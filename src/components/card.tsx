...
export const Card = ({ img, name, description }: CardProps) => {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gray-800 after:opacity-90 opacity-20 transition-opacity duration-500 ease-in-out group-hover:opacity-90 z-10">
        <div className="absolute   bottom-40 left-10  opacity-0 group-hover:opacity-100 transition-opacity duration-200">
